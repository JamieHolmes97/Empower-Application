  ...
  return (
    <>
      <div className="min-h-full">
          ...
          <div>
            <Box sx={{ flexGrow: 1 }}>
              <Grid container spacing={2}>
                <Grid item xs={12}>
                  <ExpenseDetailsCard
                    expenseData={data.filteredBudget[0]}
        ...
        >
          <Box className="fixed inset-0 flex items-center justify-center" style={{ zIndex: 9999 }}>
            <Box className="bg-white p-8 rounded-lg shadow-md w-full max-w-md ">
              <h2 className="text-2xl font-semibold mb-6">Would you like to add an expense to your budget?</h2>
        ...
        >
          <Box className="fixed inset-0 flex items-center justify-center" style={{ zIndex: 9999 }}>
            <Box className="bg-white p-8 rounded-lg shadow-md w-full max-w-md ">
              <h2 className="text-2xl font-semibold mb-6">Are you sure you want to DELETE your Budget?</h2>
              <h3 className="text-1xl mb-6">
